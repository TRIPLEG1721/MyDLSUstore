...
<body>
    ...
    <section id="upload_container">
        <form action="upload.php" method="POST" enctype="multipart/form-data" >
            ...
            <input type="number" name="price" id="price" placeholder="Discounted Price" required>
            <input type="number" name="discount" id="discount" placeholder="Original Price">
